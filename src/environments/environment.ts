...
export const environment = {
    ...
    env: {
        ...
        backend: {
            ...
            use_goauth: true,
            backend_prefix:"",
            get_auth_providers: "auth/getSupportedAuthProviders",
            gooath: "auth/googlesignin",
            get_user_profile: "authuseractions/getUserProfile",
            request_user_profile: "authuseractions/requestUserProfile",
            request_update_user_profile: "authuseractions/requestUpdateUserProfile",
            update_user_profile: "authuseractions/updateUserProfile",
            get_users: "authuseractions/getUsers",
            request_user_activation: "authuseractions/requestUserActivation",
            get_scp_entities_based_on_criteria: "scpentities/getUniqueSCPEntitiesBasedOnCriteria",
            get_scp_entities_based_on_name:"scpentities/getSCPEntityLabelsBasedOnName",
            switch_entity_moderation:"scpentities/switchEntityModeration",
            delete_scp_entities: "scpentities/deleteSCPEntities",
            verify_scp_entities: "scpentities/verifySCPEntities",
            check_scp_entity_exists:"scpentities/checkSCPEntityExists",
            create_scp_entity_label:"scpentities/createSCPEntityLabel",
            update_scp_entity_label:"scpentities/updateSCPEntityLabel",
            get_scp_groups: "scpgroups/getSCPGroups",
            get_domains: "domains/getDomains",
            search_city:"location/searchCity",
            search_country:"location/searchCountry",
            get_user_defined_stakeholders: "stakeholders/getUserDefinedStakeholders",
            add_user_defined_stakeholder: "stakeholders/addUserDefinedStakeholder",
            get_stakeholders:"stakeholders/get",
            get_moderated_stakeholders:"stakeholders/getModeratedStakeholders",
            get_stakeholder_roles:"stakeholders/getStakeholderRoles",
            ...
            timezones: "timezones",
            activity_formats: "activity-formats",
            languages: "languages",
            location: "location",
            ...
            ll_user_membership_postfix: "ll-user-membership",
            ...
            asset_resource_types: "asset-resource-types",
        ...
        oaoauth: {
            ...
            img_height:70,
            login_url:"",
            redirect_url:"http://localhost:8080/auth/openairesignin",
            client_id:"",
        ...
        user_landing_page: {
            views: [
                ...
                /*{ name: "livingLabManagement", desc: "Living Lab Management", scope: "ADMINISTRATION", url: "/living-lab-management", breadcrumb_label: "Moderate Suggestions", breadcrumb_path: [{ name: "Living Lab Modeler", key: "home" }, { name: "Administration", key: "" }, { name: "Living Lab Management", key: "" }], permissions: ["view_living_labs", "edit_living_labs","edit_living_labs","add_living_labs"],icon:"space_dashboard",uses_recaptcha:false },*/
...
//           {id:"members",icon:"assets/members.png",tooltip:"Your Living Lab members",name:"Members"},
]
        },
        llLocation:{
        ...
        footer: {
            ...
            text: {
                ...
                "terms-of-use":{"text":"Terms of Use","link":"#/llm/terms-of-use"},
